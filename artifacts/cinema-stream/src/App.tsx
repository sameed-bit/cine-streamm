  ...
  return (
    ...
    >
      <div className="cinema-poster-shell group relative aspect-[2/3] overflow-hidden rounded-xl border border-white/8">
        ...
        <Link
          href={href}
          className="absolute inset-x-0 bottom-0 z-[2] bg-gradient-to-t from-black via-black/70 to-transparent px-3.5 pb-4 pt-16 text-white opacity-0 transition-all duration-500 group-hover:opacity-100"
        >
      ...
      <div className="flex items-start justify-between gap-2 pt-3.5">
        <Link
          href={href}
          className="line-clamp-1 text-[15px] font-semibold text-foreground transition-all duration-300 hover:translate-x-1 hover:text-primary"
        >
          {item.title}
        </Link>
...
function Home() {
  ...
  return (
    <div className="space-y-14">
      ...
      <section
        className="relative -mx-5 min-h-[620px] overflow-hidden border-b border-white/10 lg:-mx-10"
        style={{
          fontFamily:
            '-apple-system, BlinkMacSystemFont, "SF Pro Display", "SF Pro Text", "Helvetica Neue", Helvetica, Arial, sans-serif',
        }}
      >
        ...
        <div className="relative flex min-h-[620px] max-w-2xl flex-col justify-end px-5 pb-16 lg:px-10 lg:pb-20">
          <h1 className="max-w-xl text-[2.6rem] font-semibold leading-[1.08] tracking-[-0.02em] text-white drop-shadow-[0_2px_24px_rgba(0,0,0,0.35)] sm:text-[3.75rem]">
            {hero?.title || 'Something worth staying up for.'}
          </h1>
          <p className="mt-5 max-w-lg text-[16px] font-normal leading-[1.55] text-white/85 sm:text-[17.5px]">
            {hero?.overview ||
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="flex items-center gap-2.5 rounded-2xl bg-primary px-6 py-3.5 text-[13px] font-semibold tracking-wide text-primary-foreground shadow-lg shadow-primary/30 transition hover:brightness-110"
            >
            ...
            {heroTrailer && (
              <button
                ...
                className="flex items-center gap-2.5 rounded-2xl border border-white/25 bg-white/10 px-6 py-3.5 text-[13px] font-semibold tracking-wide text-white backdrop-blur-md transition hover:bg-white/18"
              >
...
function Detail({ type }: { type: 'movie' | 'tv' }) {
  ...
  return (
    <>
      ...
      <div className="relative -mx-5 overflow-hidden lg:-mx-10">
      <div className="relative min-h-[640px] border-b border-white/10">
        ...
        <div className="relative flex min-h-[640px] items-end px-5 pb-16 lg:px-10 lg:pb-20">
          <div className="grid w-full max-w-5xl gap-8 sm:grid-cols-[200px_1fr] sm:items-end">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-[16.5px] leading-7 text-muted-foreground">
                {detail.overview || 'A story waiting to be discovered.'}
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <PlayOrAuthLink
                  href={href}
                  className="flex items-center gap-2.5 rounded-xl bg-primary px-6 py-3.5 text-sm font-bold uppercase tracking-[0.12em] text-primary-foreground shadow-lg shadow-primary/25"
                >
                  <Play className="h-4.5 w-4.5 fill-current" />
                  Watch now
                </PlayOrAuthLink>
                ...
                {trailer && (
                  <button
                    ...
                    className="flex items-center gap-2.5 rounded-xl border border-white/20 bg-black/30 px-6 py-3.5 text-sm font-bold uppercase tracking-[0.12em] text-foreground backdrop-blur transition hover:border-primary hover:text-primary"
                  >
                    <Clapperboard className="h-4.5 w-4.5" />
                    Trailer
                  </button>
                ...
                {user && (
                  <button
                    onClick={() => toggle(item)}
                    className="flex items-center gap-2.5 rounded-xl border border-white/20 px-6 py-3.5 text-sm font-bold uppercase tracking-[0.12em]"
                  >
                    <Bookmark
      ...
      <div className="space-y-14 px-5 py-14 lg:px-10">
